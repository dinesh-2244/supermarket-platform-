/**
 * Use-cases for `notifications`. Services open transactions, enforce authorization and
 * emit domain events; they are the only thing `index.ts` exposes.
 *
 * Phase 1 is a skeleton — this module emits nothing once its use-cases exist.
 */
