/**
 * Pure domain logic for `orders` — no I/O, no Prisma, no framework types.
...
export const descriptor: ModuleDescriptor = {
  name: 'orders',
  owns: 'Order, OrderLine, OrderStatusHistory, the state machine, admin correction',
  dependsOn: ['platform', 'inventory'],
  emits: ['order.<transition>'],
};
