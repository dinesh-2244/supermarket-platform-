...
import { findProductIdsBySku, productIdsSetUpForStore } from '../catalog/index';
...
export async function planStockImport(
  ...
  const listed = await productIdsSetUpForStore(principal, input.storeId, [
    ...productIdBySku.values(),
  ]);
