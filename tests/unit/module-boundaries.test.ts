...
describe('module boundaries', () => {
  it('rejects a cross-module deep import', async () => {
  ...
  it('rejects reaching into another module’s domain internals', async () => {
    const results = await lintFixture(
  ...
  it('rejects app/** importing a module repo', async () => {
    const results = await lintFixture(
  ...
  it('rejects app/** importing the Prisma client directly', async () => {
    const results = await lintFixture(
  ...
  it('rejects src/lib importing domain modules', async () => {
    const results = await lintFixture(
  ...
  it('allows the legal import: another module through its index.ts', async () => {
    const results = await lintFixture(
