/**
 * Prisma / SQL access for `notifications`. Private to this module: nothing outside
 * `src/modules/notifications` may import this file, and `import/no-restricted-paths`
 * enforces that.
 *
