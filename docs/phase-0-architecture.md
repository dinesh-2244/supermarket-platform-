...
| `fulfillment` | PickTask, PosBillingHandoff (+ variance calc), DeliveryRecord | platform, orders, inventory, pricing, identity, notifications | `order.picked`, `order.billed`, `order.delivered` |
